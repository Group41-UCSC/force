...
import 'package:batch_sheet/pages/table_issued/data/item.dart';
...
class _TableIssuedPageState extends State<TableIssuedPage> {
  ...
  void onSort(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      items.sort((item1, item2) =>
          compareString(ascending, '${item1.issuedTo}', '${item2.issuedTo}'));
    } else if (columnIndex == 4) {
      items.sort((item1, item2) => compareString(
          ascending, '${item1.supervisor}', '${item2.supervisor}'));
    }
    setState(() {
            ...
            (item) => DataRow(
                ...
                cells: [
                  ...
                  DataCell(
                    Text(item.issuedTo),
                    onTap: () {
                      print('Selected ${item.issuedTo}');
                    },
                  ),
                  DataCell(
                    Text(item.supervisor),
                    onTap: () {
                      print('Selected ${item.supervisor}');
                    },
                  ),
                  DataCell(
                    FlatButton(
