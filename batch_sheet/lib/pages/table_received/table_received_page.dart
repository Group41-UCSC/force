...
import 'package:batch_sheet/pages/table_received/data/item.dart';
  ...
  void onSort(int columnIndex, bool ascending) {
    if (columnIndex == 0) {
      ...
      items.sort((item1, item2) => compareString(
          ascending, '${item1.receivedDate}', '${item2.receivedDate}'));
    }
    setState(() {
  ...
  DataTable dataBody() {
    return DataTable(
      ...
      columns: [
        ...
        DataColumn(
            label: Text("Send To Headquarters"),
            numeric: false,
            onSort: (columnIndex, ascending) {
              setState(() {
                sort = !sort;
            ...
            (item) => DataRow(
                ...
                cells: [
                  ...
                  DataCell(
                    ...
                    onTap: () {
                      print('Selected ${item.receivedDate}');
                    },
                  ),
                  DataCell(
                    FlatButton(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: TextButton.icon(
                    ...
                    label: Text('RECEIVED BADGE SHEET',
