import 'package:inventory_folder/pages/table_item/widget/item.dart';
...
import 'package:inventory_folder/pages/form/form_edit.dart';
                ...
                Padding(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => FormEdit()),
                      );
                    },
                  ),
                ),
