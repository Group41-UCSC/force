...
List<ButtonsInfo> _buttonNames = [
  ...
  ButtonsInfo(title: "Item List", icon: Icons.inventory_2_outlined),
  ButtonsInfo(title: "Requested List", icon: Icons.add_shopping_cart),
  ButtonsInfo(title: "Costing", icon: Icons.account_balance_wallet_outlined),
];
              ...
              ListTile(
                ...
                trailing: !ResponsiveLayout.isComputer(context)
                    ? IconButton(
                        ...
                        icon: Icon(Icons.close, color: Constants.lightGrey),
                      )
                    : null,
              ),
              ...List.generate(
                      ...
                      decoration: index == _currentIndex
                          ? BoxDecoration(
                              ...
                              gradient: LinearGradient(
                                colors: [
                                  Constants.light.withOpacity(0.9),
                                  Constants.light.withOpacity(0.9),
                                ],
                              ),
                            )
