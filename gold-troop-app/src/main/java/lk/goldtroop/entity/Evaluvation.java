...
public class Evaluvation {
    ...
    public Evaluvation(Integer evaluvationId, Integer evaluvationChildId, String evaluvationTitle, String evaluvationVersion, String evaluvationStartdate, String evaluvationEnddate) {
